...
@Component({
  ...
  templateUrl: './show-seance.component.html',
  styleUrls: ['./show-seance.component.sass']
})
export class ShowSeanceComponent {
//   @ViewChild('seance', { static: false })
//   seance: Seance | null;
...
//   seanceEvents: EventInput[];
//   tempEvents: EventInput[];

//   public filters = [
//     { name: 'Seances Planifiees', value: 'Seances Planifiees', checked: true },
//     { name: 'Seances libres', value: 'Seances libres', checked: true },
//   ];
...
//     public seanceService: ShowSeanceService,
...
//     this.seanceEvents = INITIAL_EVENTS;
//     //this.getAllSeances();
//     this.tempEvents = this.seanceEvents;
//     this.calendarOptions.initialEvents = this.seanceEvents;
...
// // this.calendarService.getAllSeances().subscribe(
// //   data => {
// //     if (data) {
// //       console.log(data);
// //       data.forEach(element=>this.seancesList.push(element));
// //       this.seancesList=data;
// //       this.showNotification(
// //         'snackbar-succes',
// //         'seances importer avec succes...!!!',
// //         'bottom',
// //         'center'
// //       ); }
// //       else{
...
// //     this.seancesList.forEach(element=>{
// //       this.calendarEvents
// //     });
...
//   filterEvent(element) {
//     const list = this.seanceEvents.filter((x) =>
